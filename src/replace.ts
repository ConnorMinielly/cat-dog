/**
 * A generic recursive replacement function that will crawl any object provided to it's initial call and replace
 * any string value that is exactly equal to the "match" param with the value of the "replacement" param. This
 * function should handle any JSON structure of any arbitrary complexity, as well as arrays and individual values.
